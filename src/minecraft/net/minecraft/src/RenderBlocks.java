...
public class RenderBlocks
{
    ...
    public boolean renderBlockFluids(Block block, int i, int j, int k)
    {
        ...
        if(renderAllFaces || flag)
        {
            ...
            double d9 = (double)(MathHelper.sin(f8) * 8F) / 256D;
            double d11 = (double)(MathHelper.cos(f8) * 8F) / 256D;
            tessellator.func_35835_b(block.func_35275_c(blockAccess, i, j, k));
            float f9 = 1.0F;
        ...
        for(int k1 = 0; k1 < 4; k1++)
        {
            ...
            flag2 = true;
            double d16 = (float)(j3 + 0) / 256F;
            double d17 = ((double)(j3 + 16) - 0.01D) / 256D;
            double d18 = ((double)k3 + (1.0D - d8) * 16D) / 256D;
            double d19 = ((double)k3 + (1.0D - d10) * 16D) / 256D;
            double d20 = ((double)(k3 + 16) - 0.01D) / 256D;
            tessellator.func_35835_b(block.func_35275_c(blockAccess, l1, j2, l2));
            float f10 = 1.0F;
            if(k1 < 2)
            {
                f10 *= f5;
            ...
            tessellator.addVertexWithUV(d12, (double)j + d8, d13, d16, d18);
            tessellator.addVertexWithUV(d14, (double)j + d10, d15, d17, d19);
