...
public class GenLayerVillageLandscape extends GenLayer
{
    ...
    public GenLayerVillageLandscape(long l, GenLayer genlayer)
    {
        ...
        field_35509_b = (new BiomeGenBase[] {
            BiomeGenBase.desert, BiomeGenBase.forest, BiomeGenBase.field_35483_e, BiomeGenBase.swampland, BiomeGenBase.field_35485_c, BiomeGenBase.taiga
        });
    ...
    public int[] func_35500_a(int i, int j, int k, int l)
    {
        ...
        for(int i1 = 0; i1 < l; i1++)
        {
            for(int j1 = 0; j1 < k; j1++)
            {
                ...
                ai1[j1 + i1 * k] = ai[j1 + i1 * k] <= 0 ? 0 : field_35509_b[func_35498_a(field_35509_b.length)].field_35494_y;
            }
