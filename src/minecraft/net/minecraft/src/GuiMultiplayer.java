...
public class GuiMultiplayer extends GuiScreen
{
    ...
    public void func_35337_c()
    {
        ...
        controlList.add(field_35347_h = new GuiButton(7, width / 2 - 154, height - 28, 70, 20, stringtranslate.translateKey("selectServer.edit")));
    ...
    protected void actionPerformed(GuiButton guibutton)
    {
        ...
        {
            field_35351_u = true;
            mc.displayGuiScreen(new GuiScreenServerList(this, field_35349_w = new ServerNBTStorage(StatCollector.translateToLocal("selectServer.defaultName"), "")));
        } else
        if(guibutton.id == 3)
        {
            field_35353_s = true;
