...
public class ComponentStrongholdStraight extends ComponentStronghold
{
    ...
    public boolean func_35023_a(World world, Random random, StructureBoundingBox structureboundingbox)
    {
        ...
        func_35014_a(world, structureboundingbox, random, 0.1F, 1, 2, 1, Block.torchWood.blockID, 0);
        func_35014_a(world, structureboundingbox, random, 0.1F, 3, 2, 1, Block.torchWood.blockID, 0);
        func_35014_a(world, structureboundingbox, random, 0.1F, 1, 2, 5, Block.torchWood.blockID, 0);
        func_35014_a(world, structureboundingbox, random, 0.1F, 3, 2, 5, Block.torchWood.blockID, 0);
        if(field_35048_b)
        {
