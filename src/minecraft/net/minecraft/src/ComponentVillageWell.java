...
public class ComponentVillageWell extends ComponentVillage
{
    ...
    public boolean func_35023_a(World world, Random random, StructureBoundingBox structureboundingbox)
    {
        ...
        if(!field_35104_a);
        func_35011_a(world, structureboundingbox, 1, 0, 1, 4, 12, 4, Block.cobblestone.blockID, Block.waterMoving.blockID, false);
        ...
        func_35018_a(world, Block.fence.blockID, 0, 1, 13, 1, structureboundingbox);
        func_35018_a(world, Block.fence.blockID, 0, 1, 14, 1, structureboundingbox);
        func_35018_a(world, Block.fence.blockID, 0, 4, 13, 1, structureboundingbox);
        func_35018_a(world, Block.fence.blockID, 0, 4, 14, 1, structureboundingbox);
        func_35018_a(world, Block.fence.blockID, 0, 1, 13, 4, structureboundingbox);
        func_35018_a(world, Block.fence.blockID, 0, 1, 14, 4, structureboundingbox);
        func_35018_a(world, Block.fence.blockID, 0, 4, 13, 4, structureboundingbox);
        func_35018_a(world, Block.fence.blockID, 0, 4, 14, 4, structureboundingbox);
        func_35011_a(world, structureboundingbox, 1, 15, 1, 4, 15, 4, Block.cobblestone.blockID, Block.cobblestone.blockID, false);
        for(int i = 0; i <= 5; i++)
        {
            for(int j = 0; j <= 5; j++)
            {
                if(j == 0 || j == 5 || i == 0 || i == 5)
                {
                    func_35018_a(world, Block.gravel.blockID, 0, j, 11, i, structureboundingbox);
