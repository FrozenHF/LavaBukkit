...
public class ComponentVillageChurch extends ComponentVillage
{
    ...
    public boolean func_35023_a(World world, Random random, StructureBoundingBox structureboundingbox)
    {
        ...
        func_35018_a(world, Block.field_35282_br.blockID, 0, 0, 3, 2, structureboundingbox);
        func_35018_a(world, Block.field_35282_br.blockID, 0, 4, 2, 2, structureboundingbox);
        func_35018_a(world, Block.field_35282_br.blockID, 0, 4, 3, 2, structureboundingbox);
        func_35018_a(world, Block.field_35282_br.blockID, 0, 0, 6, 2, structureboundingbox);
        func_35018_a(world, Block.field_35282_br.blockID, 0, 0, 7, 2, structureboundingbox);
        func_35018_a(world, Block.field_35282_br.blockID, 0, 4, 6, 2, structureboundingbox);
        func_35018_a(world, Block.field_35282_br.blockID, 0, 4, 7, 2, structureboundingbox);
        func_35018_a(world, Block.field_35282_br.blockID, 0, 2, 6, 0, structureboundingbox);
        func_35018_a(world, Block.field_35282_br.blockID, 0, 2, 7, 0, structureboundingbox);
        func_35018_a(world, Block.field_35282_br.blockID, 0, 2, 6, 4, structureboundingbox);
        func_35018_a(world, Block.field_35282_br.blockID, 0, 2, 7, 4, structureboundingbox);
        func_35018_a(world, Block.field_35282_br.blockID, 0, 0, 3, 6, structureboundingbox);
        func_35018_a(world, Block.field_35282_br.blockID, 0, 4, 3, 6, structureboundingbox);
        func_35018_a(world, Block.field_35282_br.blockID, 0, 2, 3, 8, structureboundingbox);
