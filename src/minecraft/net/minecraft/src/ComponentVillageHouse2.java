...
public class ComponentVillageHouse2 extends ComponentVillage
{
    ...
    public boolean func_35023_a(World world, Random random, StructureBoundingBox structureboundingbox)
    {
        ...
        func_35018_a(world, Block.field_35288_bq.blockID, 0, 9, 2, 5, structureboundingbox);
        func_35018_a(world, Block.field_35288_bq.blockID, 0, 9, 2, 4, structureboundingbox);
        ...
        func_35018_a(world, Block.field_35282_br.blockID, 0, 0, 2, 4, structureboundingbox);
        func_35018_a(world, Block.field_35282_br.blockID, 0, 2, 2, 6, structureboundingbox);
        func_35018_a(world, Block.field_35282_br.blockID, 0, 4, 2, 6, structureboundingbox);
