...
public class ComponentVillageHouse3 extends ComponentVillage
{
    ...
    public boolean func_35023_a(World world, Random random, StructureBoundingBox structureboundingbox)
    {
        ...
        func_35018_a(world, Block.field_35282_br.blockID, 0, 8, 2, 7, structureboundingbox);
        func_35018_a(world, Block.field_35282_br.blockID, 0, 8, 2, 8, structureboundingbox);
        ...
        func_35018_a(world, Block.field_35282_br.blockID, 0, 2, 2, 7, structureboundingbox);
        func_35018_a(world, Block.field_35282_br.blockID, 0, 2, 2, 8, structureboundingbox);
        ...
        func_35018_a(world, Block.field_35282_br.blockID, 0, 5, 4, 10, structureboundingbox);
