    ...
    implements IChunkProvider
{
    ...
    public ChunkProvider(World world, IChunkLoader ichunkloader, IChunkProvider ichunkprovider)
    {
        ...
        world.getClass();
        field_28064_b = new EmptyChunk(world, new byte[256 * 128], 0, 0);
        worldObj = world;
    ...
    {
        return (new StringBuilder()).append("ServerChunkCache: ").append(chunkMap.func_35576_a()).append(" Drop: ").append(droppedChunksSet.size()).toString();
    }
