...
public class ComponentMineshaftCorridor extends StructureComponent
{
    ...
    public boolean func_35023_a(World world, Random random, StructureBoundingBox structureboundingbox)
    {
        ...
        if(field_35068_b)
        {
            func_35010_a(world, structureboundingbox, random, 0.6F, 0, 0, 0, 2, 1, i, Block.web.blockID, 0, false);
        }
        for(int j = 0; j < field_35067_d; j++)
        {
            int l = 2 + j * 5;
            func_35011_a(world, structureboundingbox, 0, 0, l, 0, 1, l, Block.fence.blockID, 0, false);
            func_35011_a(world, structureboundingbox, 2, 0, l, 2, 1, l, Block.fence.blockID, 0, false);
            if(random.nextInt(4) != 0)
            {
                func_35011_a(world, structureboundingbox, 0, 2, l, 2, 2, l, Block.planks.blockID, 0, false);
            } else
            {
                func_35011_a(world, structureboundingbox, 0, 2, l, 0, 2, l, Block.planks.blockID, 0, false);
                func_35011_a(world, structureboundingbox, 2, 2, l, 2, 2, l, Block.planks.blockID, 0, false);
            }
            func_35014_a(world, structureboundingbox, random, 0.1F, 0, 2, l - 1, Block.web.blockID, 0);
            func_35014_a(world, structureboundingbox, random, 0.1F, 2, 2, l - 1, Block.web.blockID, 0);
            func_35014_a(world, structureboundingbox, random, 0.1F, 0, 2, l + 1, Block.web.blockID, 0);
            func_35014_a(world, structureboundingbox, random, 0.1F, 2, 2, l + 1, Block.web.blockID, 0);
            func_35014_a(world, structureboundingbox, random, 0.05F, 0, 2, l - 2, Block.web.blockID, 0);
            func_35014_a(world, structureboundingbox, random, 0.05F, 2, 2, l - 2, Block.web.blockID, 0);
            func_35014_a(world, structureboundingbox, random, 0.05F, 0, 2, l + 2, Block.web.blockID, 0);
            func_35014_a(world, structureboundingbox, random, 0.05F, 2, 2, l + 2, Block.web.blockID, 0);
            func_35014_a(world, structureboundingbox, random, 0.05F, 1, 2, l - 1, Block.torchWood.blockID, 0);
            func_35014_a(world, structureboundingbox, random, 0.05F, 1, 2, l + 1, Block.torchWood.blockID, 0);
        ...
        if(field_35070_a)
        {
            for(int k = 0; k <= i; k++)
            {
                ...
                {
                    func_35014_a(world, structureboundingbox, random, 0.7F, 1, 0, k, Block.rail.blockID, func_35009_c(Block.rail.blockID, 0));
                }
            }
