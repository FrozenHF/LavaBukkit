...
class GuiSlotServer extends GuiSlot
{
    ...
    protected void elementClicked(int i, boolean flag)
    {
        ...
        boolean flag1 = GuiMultiplayer.func_35333_b(field_35410_a) >= 0 && GuiMultiplayer.func_35333_b(field_35410_a) < getSize();
        GuiMultiplayer.func_35329_c(field_35410_a).enabled = flag1;
        GuiMultiplayer.func_35334_d(field_35410_a).enabled = flag1;
        GuiMultiplayer.func_35339_e(field_35410_a).enabled = flag1;
        if(flag && flag1)
        {
