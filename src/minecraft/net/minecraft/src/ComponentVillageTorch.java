...
public class ComponentVillageTorch extends ComponentVillage
{
    ...
    public boolean func_35023_a(World world, Random random, StructureBoundingBox structureboundingbox)
    {
        ...
        func_35018_a(world, Block.fence.blockID, 0, 1, 0, 0, structureboundingbox);
        func_35018_a(world, Block.fence.blockID, 0, 1, 1, 0, structureboundingbox);
        func_35018_a(world, Block.fence.blockID, 0, 1, 2, 0, structureboundingbox);
        func_35018_a(world, Block.cloth.blockID, 15, 1, 3, 0, structureboundingbox);
        func_35018_a(world, Block.torchWood.blockID, 15, 0, 3, 0, structureboundingbox);
        func_35018_a(world, Block.torchWood.blockID, 15, 1, 3, 1, structureboundingbox);
        func_35018_a(world, Block.torchWood.blockID, 15, 2, 3, 0, structureboundingbox);
        func_35018_a(world, Block.torchWood.blockID, 15, 1, 3, -1, structureboundingbox);
        return true;
    }
